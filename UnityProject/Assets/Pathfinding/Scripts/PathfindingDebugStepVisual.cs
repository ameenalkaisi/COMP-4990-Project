...
public class PathfindingDebugStepVisual : MonoBehaviour {
    ...
    public void TakeSnapshot(GridMap<PathNode> grid, PathNode current, List<PathNode> openList, List<PathNode> closedList) {
    ...
    public void TakeSnapshotFinalPath(GridMap<PathNode> grid, List<PathNode> path) {
        GridSnapshotAction gridSnapshotAction = new GridSnapshotAction();
        gridSnapshotAction.AddAction(HideNodeVisuals);
